                ...
                {loading ? (
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full min-w-[1000px] table-fixed">
                      <thead className="bg-gray-50">
                        <tr>
                          <th className="px-6 py-3 text-left text-sm font-semibold text-gray-700 min-w-[280px]">Vendor</th>
                          ...
                          <th className="px-6 py-3 text-left text-sm font-semibold text-gray-700 min-w-[100px]">Items</th>
                          <th className="px-6 py-3 text-left text-sm font-semibold text-gray-700 min-w-[160px]">Total Amount</th>
                          <th className="px-6 py-3 text-left text-sm font-semibold text-gray-700 min-w-[140px]">Notes</th>
                          <th className="px-6 py-3 text-left text-sm font-semibold text-gray-700 min-w-[100px]">Actions</th>
                        </tr>
                      </thead>
                      <tbody>
                        {filteredPurchases.map((purchase) => (
                          <tr key={purchase.id} className="border-t hover:bg-gray-50">
                            <td className="px-6 py-4 text-sm text-gray-900 font-medium max-w-[280px] truncate" title={purchase.vendor_name}>{purchase.vendor_name}</td>
                            ...
                            <td className="px-6 py-4 text-sm text-gray-900 font-semibold flex items-center gap-1 whitespace-nowrap">
                              <span className="ml-1">₹{Number(purchase.total_amount || 0).toLocaleString(undefined, {minimumFractionDigits:2, maximumFractionDigits:2})}</span>
                            </td>
